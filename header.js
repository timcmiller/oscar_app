  ...
  renderFilterHeader() {
    return (
      <View style={this.props.showFilter && styles.expanded}>
        ...
        <ListView
        dataSource={ds.cloneWithRows(['Picture', 'Director', 'Actor', 'Actress', 'Supporting Actor', 'Supporting Actress', 'Original Screenplay', 'Adapted Screenplay', 'Animated Feature Film', 'Foreign Language File', 'Documentary - Feature', 'Documentary - Short Subject', 'Live Action Short Film', 'Animated Short Film', 'Original Score', 'Original Song', 'Sound Editing', 'Sound Mixing', 'Production Design', 'Cinematography', 'Makeup and Hairstyling', 'Costume Design', 'Film Editing', 'Visual Effects'])}
